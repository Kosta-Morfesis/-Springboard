...
WHERE b.starttime >= '2012-09-14' 
  ...
  AND ((m.memid = 0 AND f.guestcost > 30.0) OR (m.memid <> 0 AND f.membercost > 30.0))
ORDER BY cost DESC
...
WHERE b.starttime >= '2012-09-14' 
  AND b.starttime < '2012-09-15'
  AND (SELECT CASE WHEN m.memid = 0 AND f.guestcost > 30.0 THEN f.guestcost 
